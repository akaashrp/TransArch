...
def prepare(args):
    ...
    plan = {"schema_version": 1, "root": str(root), "project": str(PROJECT), "data": str(data),
            ...
            "protocol": {"calibration": "128 sequences capped at 256 tokens, train split, seed 42; actual token count recorded",
                         ...
                         "harness": "lm_eval 0.4.12 defaults; MMLU and GSM8K 5-shot, fixed fewshot seed 1234",
                         "gsm8k": {"num_fewshot": 5, "fewshot_seed": 1234,
                                   "apply_chat_template": True, "fewshot_as_multiturn": False,
                                   "enable_thinking": False, "max_new_tokens": 1024, "do_sample": False},
